...
import cabanas.garcia.ismael.meetup.meetings.domain.configuration.MeetingGroupConfigurationMother
...
class MeetingCommentShould {
    ...
    fun `create a successful meeting comment`() {
        val meetingComment = MeetingCommentFactory.create(
            MeetingCommentId(SOME_MEETING_COMMENT_ID),
            SOME_MEETING_ID,
            MemberId(SOME_AUTHOR_ID),
            SOME_COMMENT,
